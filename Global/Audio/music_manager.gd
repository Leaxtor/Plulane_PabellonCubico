...
const MUSIC_MAP : Dictionary = {
	Music.INTRO: preload("res://Global/Audio/Musica/MP3/Ambient Vol10 Dreth Mirage Cut 30.wav"),
	Music.MENU: preload("res://Global/Audio/Musica/MP3/kanpyo_2012_fairy_starsapphire.mp3"),
	Music.STAGE1: preload("res://Global/Audio/Musica/MP3/menu.mp3"),
	Music.STAGE2: preload("res://Global/Audio/Musica/MP3/Watatsuki's Spell Card~ Divine Sea Battle.mp3"),
}
